...
//
var setSceneId = function (app, options) {
  app.globalData.SCENE_ID = options.sceneId || 1;
}

var getSceneId = function (app, options) {
  return app.globalData.SCENE_ID;
}

const getGlobalTestUser = function (app) {
  if (app.globalData.testUserId != undefined && app.globalData.testUserId != null && app.globalData.testUserId != "") {
    return app.globalData.testUserId;
  } else {
    return app.globalData.USER_ID;
  }
}
...
const rootDocment = 'https://minipro.fpaworld.com/fpa-wechat/';
